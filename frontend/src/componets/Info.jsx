...
const Info = () => {
    ...
    return (
        <div className="min-h-screen bg-[#F0E6F7] text-slate-800 font-sans relative overflow-hidden">
            <Helmet>
                <title>Rwanda Traffic Rules & Road Signs - Umutoza Info Hub</title>
                <meta name="description" content="Soma amategeko y'umuhanda n'ibisobanuro by'ibyapa mu Rwanda. Complete guide to passing your Rwanda provisional driving test with official road rules and signs." />
                <meta name="keywords" content="Rwanda road signs meanings, Amategeko y'umuhanda mu Rwanda 2024, Ibyapa by'umuhanda, Rwanda traffic regulations, Provisional permit requirements Rwanda" />
            </Helmet>
            ...
            <div className="pt-32 pb-20 px-6 md:px-12 lg:px-24 container mx-auto">
                ...
                <div className="glass rounded-[50px] p-12 md:p-20 text-center shadow-2xl relative overflow-hidden" data-aos="zoom-in">
                    ...
                    <button onClick={() => navigate('/test')} className="px-10 py-5 bg-indigo-600 text-white rounded-[25px] font-black text-xl shadow-xl hover:bg-indigo-700 transition-all active:scale-95 relative z-10">Tangira Imyitozo</button>
                </div>
            </div>
