...
const Landingpage = () => {
  ...
  return (
    <div className="min-h-screen bg-[#F0E6F7] text-slate-800 selection:bg-primary-light selection:text-white overflow-hidden font-sans relative">
      <Helmet>
        <title>Umutoza - Pass Your Rwanda Provisional Driving Test 2024/2025</title>
        <meta name="description" content="Umutoza ni urubuga rwa mbere mu Rwanda rugufasha kwitegura neza ikizamini cy'uruhushya rw'agateganyo. Pass your Rwanda provisional driving license test (Amategeko y'umuhanda) with our modern mock exams and road sign guides." />
        <meta name="keywords" content="Rwanda provisional driving test, Amategeko y'umuhanda Rwanda, Ibizamini by'amategeko y'umuhanda, Rwanda driving license, Irembo provisional permit, Rwanda road signs, Umutoza Rwanda, Provisional permit questions Rwanda" />
        <meta name="author" content="Umutoza" />

        {/* Open Graph / Facebook */}
        <meta property="og:type" content="website" />
        <meta property="og:url" content="https://umutoza.pages.dev/" />
        <meta property="og:title" content="Umutoza - Inzira y'Intsinzi mu Bizamini by'Umuhanda" />
        <meta property="og:description" content="Itegure gutsinda ikizamini cy'agateganyo mu Rwanda ku nshuro ya mbere. Comprehensive mock tests for Rwanda Traffic Rules." />
        <meta property="og:image" content="https://umutoza.pages.dev/umutoza.png" />

        {/* Twitter */}
        <meta property="twitter:card" content="summary_large_image" />
        <meta property="twitter:url" content="https://umutoza.pages.dev/" />
        <meta property="twitter:title" content="Pass Your Rwanda Driving Test with Umutoza" />
        <meta property="twitter:description" content="The #1 platform for Rwanda Provisional License preparation. Try our free tests today." />
        <meta property="twitter:image" content="https://umutoza.pages.dev/umutoza.png" />

        {/* Geo Tags for Rwanda SEO */}
      ...
      <footer className="relative z-10 px-6 py-12 md:px-12 lg:px-24 border-t border-indigo-100 mt-20">
        <div className="flex flex-col md:flex-row justify-between items-center text-indigo-800/50 text-sm font-medium">
          ...
          <div className="flex space-x-8">
            <button onClick={() => navigate('/info')} className="hover:text-indigo-600">Serivisi</button>
            <button onClick={() => navigate('/contact')} className="hover:text-indigo-600">Tuvugishe</button>
            <button onClick={() => navigate('/admin/login')} className="hover:text-amber-600 font-bold opacity-80">Admin</button>
