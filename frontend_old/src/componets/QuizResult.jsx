            ...
            <div className="max-w-4xl mx-auto relative z-10">
                <div className="glass rounded-[50px] overflow-hidden shadow-2xl bg-white/80 backdrop-blur-xl border border-white/60">
                    ...
                    <div className="p-8 md:p-12">
                        ...
                        <button onClick={() => window.location.reload()} className="w-full py-6 bg-indigo-600 hover:bg-indigo-700 text-white rounded-[30px] font-black text-xl shadow-xl active:scale-95 transition-all">GERAGEZA BUSHYA</button>
                    </div>
                </div>
            </div>
